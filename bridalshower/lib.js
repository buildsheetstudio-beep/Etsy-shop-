...
const C = {
  dustyRose:    '#8B5E6A',  // Primary header
  medDustyRose: '#A5707A',  // Secondary header
  gold:         '#C9A96E',  // Antique Gold accent
  parchment:    '#FAF6EE',  // Alternating rows / KPI bg
  ivory:        '#FFFDF9',  // Input cells
  paleRose:     '#F5EEF0',  // Formula/auto cells
  sage:         '#5A7A5A',  // Positive/done
  amber:        '#8B7340',  // Warning/pending
  deepRose:     '#8B3A4A',  // Negative/declined
  text:         '#2A1A20',  // Body text
  muted:        '#7A5A60',  // Secondary text
  white:        '#FFFFFF',
  border:       '#E8D5D8',  // Soft rose border
};
