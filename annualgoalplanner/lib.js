...
const C = {
  midnightBlue: '#0A0F3D',  // Primary header, goal rows
  deepNavy:     '#1A2060',  // Secondary header
  electricGold: '#C9A800',  // Accent / gold text
  paleGold:     '#FBF7E4',  // Alternating rows
  white:        '#FFFFFF',  // Input cells
  paleBlue:     '#EEF0FF',  // Formula/auto cells
  emerald:      '#2ECC71',  // Achieved / 100%
  brightGold:   '#F4D03F',  // 50%+ progress
  alertRed:     '#E74C3C',  // At risk / overdue
  slateGrey:    '#95A5A6',  // Not started
  bodyText:     '#0D1117',  // Body text
  medSlate:     '#4A5568',  // Secondary text
  milestoneRow: '#F0F2FF',  // Milestone row bg
