...
const C = {
  lilac:     '#9B7DB5',  // Primary header
  roseLilac: '#B58DAA',  // Secondary header
  blush:     '#D4A0B5',  // Accent
  petalPink: '#FDF5F8',  // Alternating row light
  champagne: '#F7F0E8',  // KPI bg
  ivory:     '#FFFDF9',  // Input cell bg
  paleLilac: '#F0EBF5',  // Formula cell bg
  sage:      '#5A7A5A',  // Positive/done
  amber:     '#9B7D3A',  // Warning/pending
  deepRose:  '#9B4A5A',  // Negative/overdue
  text:      '#2A2030',  // Body text
  muted:     '#7A6A7A',  // Secondary text
  white:     '#FFFFFF',
  border:    '#E5D5DF',  // Soft blush border
};
